...
- `narration-final.mp3` - final narration track generated with the participant's
  ElevenLabs voice;
- `narration-final.wav` - optional offline fallback generated by
  `render_narration.ps1`.
